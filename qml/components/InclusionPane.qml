        ...
        Rectangle {
            ...
            Rectangle {
                ...
                CustomBtn {
                    ...
                    onPressed: {
//                        console.log(inclusionPaneScroller.contentItem.children.length)
                        for(var i = inclusionPaneScroller.contentItem.children.length ; i > 0 ; i--){
                            inclusionPaneScroller.contentItem.children[i-1].destroy()
                        };
                        numExclusions = -40
                        backend.clearListSelection("included")
                    }
                }
...
//                            console.log( `excPath${numExclusions}`)
                            ...
                            const details = comm.createObject(inclusionPaneScroller.contentItem,
                                                            {
            ...
            FileDialog {
                ...
                onAccepted: {
                    backend.selectFolder(folderSector.fileUrl)
